...
const MachineryBasedCalc = () => {
    ...
    useEffect(() => {
        const calculateFootprint = () => {
            ...
            setResult(`Estimated Carbon Footprint: ${calculatedFootprint.toFixed(2)} kg CO2`);
        };
                    ...
                    <div className="row no-gutters">
                        <div className="col-md-12 text-white p-4" style={{ background: '#0D1321' }}>
                            <h2 className="text-3xl font-bold mb-4 d-flex align-items-center">
                                <FaIndustry className="mr-2" /> Machinery Carbon Footprint Calculator
                            </h2>
                            <form className="d-flex flex-column justify-content-center" onSubmit={handleSubmit}>
                                ...
                                >
                                    <FaCog className="mr-2 spin" /> Submit
                                </button>
                            </form>
